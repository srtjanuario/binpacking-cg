...
static void report1(IloCplex &binPackingSolver, IloNumVarArray Lambda, IloRangeArray Fill);
static void report2(IloAlgorithm &patSolver,
                    IloNumVarArray Use,
                    IloObjective obj);
static void report3(IloCplex &binPackingSolver, IloNumVarArray Lambda);
...
int main(int argc, char **argv)
{
   ...
   try
   {
      ...
      while (true)
      {
         ...
         report1 (binPackingSolver, Lambda, Fill);
      ...
      report3(binPackingSolver, Lambda);
   }
...
static void report1(IloCplex &binPackingSolver, IloNumVarArray Lambda,
                    IloRangeArray Fill)
{
   cout << endl;
